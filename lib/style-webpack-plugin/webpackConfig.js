...
exports.default = (options) => {
    ...
    const miniCssExtractConf = {
        ...
        options: {
            hmr: env_1.NODE_ENV === 'development',
            reloadAll: true
        }
    };
    ...
    const commonLoaders = [
         ...
         * 生成css样式为html行内样式
         */
        env_1.NODE_ENV === 'development' ? { loader: styleLoaderName } : miniCssExtractConf,
        /**
         * 处理其他预编译样式生成的css
         */
     ...
     * 启用缓存
     */
    if (env_1.NODE_ENV === 'development' && options.cacheDirectory) {
