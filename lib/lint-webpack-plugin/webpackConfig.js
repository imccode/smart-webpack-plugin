...
exports.default = (options) => {
    ...
    if (options.eslint) {
        ...
        if (userEslintConfig) {
            log_1.default.info(`已找到用户的${chalk_1.default.green('Eslint')}配置，并开启脚本代码校验`);
            /**
             * eslinter校验代码
             */
            ...
            log_1.default.warn(`未找到用户的${chalk_1.default.green('Eslint')}配置，不开启脚本代码校验`);
        }
    }
    if (options.stylelint) {
        ...
        if (userStylelintConfig) {
            log_1.default.info(`已找到用户的${chalk_1.default.green('Stylelint')}配置，并开启样式代码校验`);
            config.plugins.push(
            /**
             * 处理stylelint样式校验
             */
            ...
            log_1.default.warn(`未找到用户的${chalk_1.default.green('Stylelint')}配置，不开启样式代码校验`);
        }
    }
    return config;
};
