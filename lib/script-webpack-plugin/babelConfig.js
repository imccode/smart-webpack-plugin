...
exports.default = (options, compiler) => {
    ...
    if (userBabelConfig) {
        log_1.default.info(`已找到用户额外的${chalk_1.default.green('Babel')}配置，并合并默认配置`);
    ...
    if (config_1.isTypescript) {
        log_1.default.info(`已使用${chalk_1.default.green('Typescript')}语言专属配置`);
     ...
     */
    if (config_1.isReact) {
        log_1.default.info(`已使用${chalk_1.default.green('React')}框架专属配置`);
